...
static const Key keys[] = {
	...
	{ MODKEY,             			XF86XK_AudioMute,   spawn,     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 0%")},
	{ MODKEY,             			XF86XK_AudioRaiseVolume,   spawn,     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +10%")},
	{ MODKEY,             			XF86XK_AudioLowerVolume,   spawn,     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%")},
	{ MODKEY,             			XF86XK_MonBrightnessUp,   spawn,     SHCMD("brightnessctl set 10%+")},
	{ MODKEY,             			XF86XK_MonBrightnessDown,   spawn,     SHCMD("brightnessctl set 10%-")},
